...
message.channel.send(`<@${wUser.id}> DON'T BREAK THE RULES OF SERVER... THIS IS A WARNING TO YOU AFTER THIS YOU WILL BE MUTED AND IF U DID'T STOP THIS KIND OF WORK U WILL BE BANNED!`)
    }
